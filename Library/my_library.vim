...
argadd test.cpp
set stal=2
edit ~/my_github/Library/Library
...
exe 'vert 1resize ' . ((&columns * 41 + 75) / 151)
exe '2resize ' . ((&lines * 23 + 25) / 51)
exe 'vert 2resize ' . ((&columns * 41 + 75) / 151)
exe '3resize ' . ((&lines * 37 + 25) / 51)
exe 'vert 3resize ' . ((&columns * 109 + 75) / 151)
exe '4resize ' . ((&lines * 10 + 25) / 51)
exe 'vert 4resize ' . ((&columns * 109 + 75) / 151)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
8
normal! 0
lcd ~/my_github/Library/Library
wincmd w
argglobal
edit ~/my_github/Library/Library/makefile
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
wincmd w
argglobal
edit ~/my_github/Library/Library/test.cpp
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 38 - ((36 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
38
...
exe '4resize ' . ((&lines * 10 + 25) / 51)
exe 'vert 4resize ' . ((&columns * 109 + 75) / 151)
tabedit ~/my_github/Library/Library/Library.cpp
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd w
argglobal
edit ~/my_github/Library/Library/Library.h
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
